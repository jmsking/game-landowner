...
class Player(object):
    ...
    @property
    def hand_card_struct(self):
        return self._hand_card_struct

    @hand_card_struct.setter
    def hand_card_struct(self, value):
        assert isinstance(value, HandCardStruct)
        self._hand_card_struct = value
